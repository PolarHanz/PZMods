...
require "../../../server/XpSystem/bonusExpUpdate"
...
--~ 	self:drawText("Hauling : " .. getPlayer():getXp():getXP(Perks.Hauling), self.x + 8, y, 1, 1, 1, 1, UIFont.Small);
	...
	self:setWidthAndParentWidth(math.max(self.width, left + UI_BORDER_SPACING*4 + self.txtLen + skillPointSize*10 + skillPointSpacing*9 + SCROLL_BAR_WIDTH + 1 + UI_BORDER_SPACING * 3));
